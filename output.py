...
if omt_path := config_data.get("omt_path"):
    ...
    omt_path = r"C:\Users\Julius Fiedler\Documents\Code\irk\irk-data\omt\omt.py"
...
if ocse_path := config_data.get("ocse_path"):
    ...
    # use hardcoded fallback
    ag_path = r"C:\Users\Julius Fiedler\Documents\Code\irk\irk-data\ocse\agents1.py"


ag = p.irkloader.load_mod_from_path(ag_path, prefix="ag")



omt = p.irkloader.load_mod_from_path(omt_path, prefix="omt")
